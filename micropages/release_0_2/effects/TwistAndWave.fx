...
float4x4 tPre <string uiname="Pre Transform";>;

float4x4 tTex: TEXTUREMATRIX <string uiname="Texture Transform";>;
float4x4 tColor <string uiname="Color Transform";>;

float fTwist <string uiname="Twist Frequency";> = 1.0;

float fXWave <string uiname="X Wave Frequency";> = 1.0;
float fXAmp <string uiname="X Wave Amplitude";> = 1.0;
float fZWave <string uiname="Z Wave Frequency";> = 1.0;
float fZAmp <string uiname="Z Wave Amplitude";> = 1.0;
