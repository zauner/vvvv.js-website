...
//texture
texture BlurTex <string uiname="Blur Map";>;
sampler BlurSamp = sampler_state    //sampler for doing the texture-lookup
{
    Texture   = (BlurTex);          //apply a texture to the sampler
    MipFilter = LINEAR;         //sampler states
    MinFilter = LINEAR;
    MagFilter = LINEAR;
};
